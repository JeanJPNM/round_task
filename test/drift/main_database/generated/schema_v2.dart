  ...
  AppSettingsTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AppSettingsTableData(
      ...
      brightness: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}brightness'])!,
...
class AppSettingsTableData extends DataClass
  ...
  const AppSettingsTableData(
      {required this.id, required this.brightness, this.seedColor});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
...
class AppSettingsTableCompanion extends UpdateCompanion<AppSettingsTableData> {
  ...
  AppSettingsTableCompanion copyWith(
      {Value<int>? id, Value<int>? brightness, Value<int?>? seedColor}) {
    return AppSettingsTableCompanion(
      id: id ?? this.id,
      brightness: brightness ?? this.brightness,
...
class DatabaseAtV2 extends GeneratedDatabase {
  ...
  late final Index idxTimeMeasurementsEnd = Index('idx_time_measurements_end',
