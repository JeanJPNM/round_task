...
class TaskFts extends Table
    with
        TableInfo<TaskFts, TaskFtsData>,
        VirtualTableInfo<TaskFts, TaskFtsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  TaskFts(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> title = GeneratedColumn<String>(
    'title',
    aliasedName,
    false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'task_fts';
  @override
  Set<GeneratedColumn> get $primaryKey => const {};
  @override
  TaskFtsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TaskFtsData(
      title: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  TaskFts createAlias(String alias) {
    return TaskFts(attachedDatabase, alias);
  }

  @override
  String get moduleAndArgs =>
      'fts5(title, description, content=\'user_tasks\', content_rowid=\'id\', tokenize=\'better_trigram remove_diacritics 1\')';
}

class TaskFtsData extends DataClass implements Insertable<TaskFtsData> {
  final String title;
  final String description;
  const TaskFtsData({required this.title, required this.description});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['title'] = Variable<String>(title);
  ...
  TaskFtsCompanion toCompanion(bool nullToAbsent) {
    return TaskFtsCompanion(
      title: Value(title),
      description: Value(description),
    );
  }

  factory TaskFtsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TaskFtsData copyWith({String? title, String? description}) => TaskFtsData(
    title: title ?? this.title,
    description: description ?? this.description,
  );
  TaskFtsData copyWithCompanion(TaskFtsCompanion data) {
    return TaskFtsData(
  ...
  @override
  String toString() {
    return (StringBuffer('TaskFtsData(')
          ..write('title: $title, ')
          ..write('description: $description')
          ..write(')'))
        .toString();
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TaskFtsData &&
          other.title == this.title &&
          other.description == this.description);
}

class TaskFtsCompanion extends UpdateCompanion<TaskFtsData> {
  final Value<String> title;
  final Value<String> description;
  final Value<int> rowid;
  const TaskFtsCompanion({
    this.title = const Value.absent(),
    this.description = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  TaskFtsCompanion.insert({
    required String title,
    required String description,
    this.rowid = const Value.absent(),
  }) : title = Value(title),
       description = Value(description);
  static Insertable<TaskFtsData> custom({
    Expression<String>? title,
    Expression<String>? description,
  ...
  @override
  String toString() {
    return (StringBuffer('TaskFtsCompanion(')
          ..write('title: $title, ')
          ..write('description: $description, ')
          ..write('rowid: $rowid')
          ..write(')'))
...
class AppSettingsTable extends Table
  ...
  @override
  List<GeneratedColumn> get $columns => [id, brightness, seedColor];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class AppSettingsTableData extends DataClass
  ...
  @override
  int get hashCode => Object.hash(id, brightness, seedColor);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class DatabaseAtV4 extends GeneratedDatabase {
  ...
  late final TaskFts taskFts = TaskFts(this);
  late final Trigger taskFtsOnTaskInsert = Trigger(
    'CREATE TRIGGER task_fts_on_task_insert AFTER INSERT ON user_tasks BEGIN INSERT INTO task_fts ("rowid", title, description) VALUES (new.id, new.title, new.description);END',
    'task_fts_on_task_insert',
  );
  late final Trigger taskFtsOnTaskDelete = Trigger(
    'CREATE TRIGGER task_fts_on_task_delete AFTER DELETE ON user_tasks BEGIN INSERT INTO task_fts (task_fts, "rowid", title, description) VALUES (\'delete\', old.id, old.title, old.description);END',
    'task_fts_on_task_delete',
  );
  late final Trigger taskFtsOnTaskUpdate = Trigger(
    'CREATE TRIGGER task_fts_on_task_update AFTER UPDATE ON user_tasks BEGIN INSERT INTO task_fts (task_fts, "rowid", title, description) VALUES (\'delete\', old.id, old.title, old.description);INSERT INTO task_fts ("rowid", title, description) VALUES (new.id, new.title, new.description);END',
    'task_fts_on_task_update',
  );
