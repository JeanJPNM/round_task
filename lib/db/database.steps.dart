...
final class Schema3 extends i0.VersionedSchema {
  ...
  late final Shape4 userTasks = Shape4(
    source: i0.VersionedTable(
      entityName: 'user_tasks',
      withoutRowId: false,
      isStrict: false,
...
i1.GeneratedColumn<int> _column_21(String aliasedName) =>
    i1.GeneratedColumn<int>(
      ...
      generatedAs: i1.GeneratedAs(
        i2.coalesce([
          (i0.VersionedTable.col<int>('start_date')),
          (i0.VersionedTable.col<int>('end_date')) -
              i2.Constant(const Duration(days: 1).inMilliseconds),
        ]),
        true,
      ),
      type: i1.DriftSqlType.int,
...
final class Schema4 extends i0.VersionedSchema {
  ...
  late final Shape5 taskFts = Shape5(
  ...
  final i1.Trigger taskFtsOnTaskInsert = i1.Trigger(
  ...
  final i1.Trigger taskFtsOnTaskDelete = i1.Trigger(
  ...
  final i1.Trigger taskFtsOnTaskUpdate = i1.Trigger(
